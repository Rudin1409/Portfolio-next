...
export function StatCard({ icon: Icon, value, title, subtitle }) {
  return (
    <div className="bg-[#1a1a24]/60 backdrop-blur-sm border border-border rounded-xl p-6 flex flex-col justify-between h-full transform transition-transform duration-300 hover:-translate-y-2 cursor-pointer">
