...
const FluidCursor = (props) => {
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl) {
      ...
      const isWebGL2 = !!gl;
      if (!isWebGL2) {
        gl = canvasEl.getContext('webgl', params) || canvasEl.getContext('experimental-webgl', params);
      }
    ...
    function render(target) {
      ...
      if (!config.TRANSPARENT) {
        ...
        gl.uniform4f(clearProgram.uniforms.color, config.BACK_COLOR.r, config.BACK_COLOR.g, config.BACK_COLOR.b, 1.0);
        blit(target);
      }
