    ...
    <div className="fixed inset-0 bg-[#0f1923] flex flex-col items-center justify-center z-[100] text-foreground p-4">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4">
        <div className="flex items-center gap-6 mb-4">
            <a href="https://github.com/ZainAhmadF28" target="_blank" aria-label="GitHub" className="cursor-target">
              <Github className="h-7 w-7 text-foreground transition-colors hover:text-primary" />
            </a>
            <a href="https://www.linkedin.com/in/zain-ahmad-f/" target="_blank" aria-label="LinkedIn" className="cursor-target">
