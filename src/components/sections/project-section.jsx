          ...
          <div className="bg-[#1a242f] rounded-full p-1.5 flex items-center gap-1 border border-border">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex justify-center items-center gap-2 py-2 px-3 sm:py-2.5 sm:px-6 rounded-full text-xs sm:text-base font-semibold transition-all duration-300 cursor-target ${activeTab === tab.id
